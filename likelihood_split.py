...
def likelihood_early(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t):
...
def likelihood_late(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t):
    """Finds the likelihood of a point realizing a minimum, for the
    travel time, beta, gamma and t* distributions determined by the
    parameters.  Beta, gamma and t* are assumed to be normally
    distributed.
...
def likelihood_kink(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t):
    """Finds the likelihood of a point realizing a minimum, for the
    travel time, beta, gamma and t* distributions determined by the
    parameters.  Beta, gamma and t* are assumed to be normally
    distributed.
...
def total_liks_early(travel_time, t_as):
    def mapped_lik(mu_b, mu_g, mu_t, sigma, sigma_t):
        lik_restr = lambda t_a: likelihood_early(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t)
        return vmap(lik_restr)(t_as)
    return mapped_lik

def total_liks_late(travel_time, t_as):
    def mapped_lik(mu_b, mu_g, mu_t, sigma, sigma_t):
        lik_restr = lambda t_a: likelihood_late(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t)
        return vmap(lik_restr)(t_as)
    return mapped_lik

def total_liks_kink(travel_time, t_as):
    def mapped_lik(mu_b, mu_g, mu_t, sigma, sigma_t):
        lik_restr = lambda t_a: likelihood_kink(travel_time, t_a, mu_b, mu_g, mu_t, sigma, sigma_t)
        return vmap(lik_restr)(t_as)
    return mapped_lik
