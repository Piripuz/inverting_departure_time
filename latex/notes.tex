...
They're not \textit{really} independent I think (maybe, or maybe they would be if \(t_a\) was distributed or something like that), and I think that this is what's causing the error in the code.
